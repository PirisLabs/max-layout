...
def component_local_ports(component: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    elif kind in {"Double-ring test block", "Grating test block", "Grating angle-taper test block", "MMI + Reference test block", "MMI split-combine test block", "Vertical-GC MZI test block", "Vertical-GC MZI + CPW test block", "Vertical-GC MZI + segmented electrode test block"}:
