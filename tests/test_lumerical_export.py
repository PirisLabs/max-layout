...
class LumericalExportTests(unittest.TestCase):
    def test_official_soi_grating_component_and_stack_defaults(self) -> None:
        ...
        self.assertEqual([row["thickness_um"] for row in stack], [3.0, 1.0, 0.12, 0.10, 0.48, 1.0])
    ...
    def test_grating_uses_only_manually_placed_ansys_style_ports(self) -> None:
        ...
        self.assertEqual(analysis["field_monitor_name"], "grating_field_uid_1")
        self.assertGreater(analysis["field_x_span_um"], 0.0)
        self.assertGreater(analysis["field_y_span_um"], 0.0)
        ...
        self.assertIn("grating_field_distribution.png", analysis_source)
        self.assertIn("field_intensity_normalized", analysis_source)
        self.assertIn('fdtd.getresult("::model::" + field_monitor_name, "E")', analysis_source)
